      ...
      child: Padding(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Ison==InspectName?Colors.deepPurpleAccent:const Color.fromARGB(255, 255, 255, 255),
                      borderRadius: BorderRadius.circular(13)),
                  child: Center(
                    child: TextButton(
                      onPressed: () {clicked(InspectName);}, 
                      child:  Text(InspectName,
                                style: GoogleFonts.poppins(
                                      letterSpacing: 0.6,
                                      color: Ison==InspectName? const Color(0xffFEFEFE):const Color(0xff39304E),
